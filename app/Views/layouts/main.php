...
<head>
  ...
  <title><?= $this->renderSection('title') ?: 'AdminLTE v4 | Dashboard' ?></title>
...
<body data-theme="light" class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
  <!--begin::App Wrapper-->
  ...
  <!-- Scripts (unchanged from your original file) -->
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Sparkline charts
  const sparkData = [
    { id: '#sparkline-1', series: [1000,1200,920,927,931,1027,819,930,1021] },
    { id: '#sparkline-2', series: [515,519,520,522,652,810,370,627,319,630,921] },
    { id: '#sparkline-3', series: [15,19,20,22,33,27,31,27,19,30,21] }
  ];
  ...
  sparkData.forEach(s => {
    if (document.querySelector(s.id)) {
      ...
      new ApexCharts(document.querySelector(s.id), options).render();
    }
  });
});
</script>

    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                ...
                <li
                    class="nav-item <?= ($segment == 'dashboard' || $segment == 'dashboard-v2' || $segment == 'dashboard-v3') ? 'menu-open' : '' ?>">
                    <a href="#"
                        class="nav-link <?= ($segment == 'dashboard' || $segment == 'dashboard-v2' || $segment == 'dashboard-v3') ? 'active' : '' ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('dashboard') ?>"
                                class="nav-link <?= ($segment == 'dashboard' && !str_contains(current_url(), 'v2') && !str_contains(current_url(), 'v3')) ? 'active' : '' ?>">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Dashboard v1</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('dashboard-v2') ?>"
                                class="nav-link <?= ($segment == 'dashboard-v2') ? 'active' : '' ?>">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Dashboard v2</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('dashboard-v3') ?>"
                                class="nav-link <?= ($segment == 'dashboard-v3') ? 'active' : '' ?>">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Dashboard v3</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="<?= base_url('students') ?>"
                        class="nav-link <?= ($segment == 'students') ? 'active' : '' ?>">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('records') ?>"
                        class="nav-link <?= ($segment == 'records') ? 'active' : '' ?>">

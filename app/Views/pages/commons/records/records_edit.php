...
<div class="container-fluid">
    <h1 class="h3 mb-3">Edit Record</h1>
    ...
    <form action="<?= base_url('records/update/' . $record['id']) ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="category" class="form-control" value="<?= old('category', $record['category']) ?>" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Price</label>
            <input type="number" name="price" class="form-control" step="0.01" value="<?= old('price', $record['price']) ?>" required>
        </div>
